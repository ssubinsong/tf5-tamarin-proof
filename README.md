...
| `sib1_freshness` | all-traces | Every accepted SIB1 was received before its MAC key's interval expired; replays arriving in a later interval are rejected at the safe-packet gate |
